...
process.on("message", (message) => {
    ...
    const jsonResponse = meetbot(message.link);
...
async function meetbot(meetLink) {
    ...
    context.overridePermissions(meetLink, ['camera', 'microphone', 'clipboard-read', 'clipboard-write']);
    ...
    await page.evaluate(() => {
        document.querySelector('#yDmH0d > c-wiz > div > div > div:nth-child(9) > div.crqnQb > div > div > div.vgJExf > div > div > div.d7iDfe.NONs6c > div > div.Sla0Yd > div > div.XCoPyb > div.uArJ5e.UQuaGc.Y5sE8d.uyXBBb.xKiqt > div.e19J0b.CeoRYc').click();
    });
    ...
    await page.waitForSelector("#ow3 > div.T4LgNb > div > div:nth-child(9) > div.crqnQb > div.DAQYgc.xPh1xb.P9KVBf > div.MaVIwe > div.Ok4Bg > div > div > div:nth-child(2) > span > button > i.google-material-icons.VfPpkd-kBDsod.NtU4hc", [{ timeout: 300000 }])
        .then(
            async () => {
